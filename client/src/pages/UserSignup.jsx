    ...
    <div className="p-7 h-screen flex flex-col justify-between">
        ...
        <form onSubmit={(e) => {
          submitHander(e);
            ...
            <h3 className="text-l mb-2 font-semibold">Whats your name?</h3>
            ...
            <p className="text-center mt-3">Already a User?<Link to = {'/login'} className="text-blue-800 ml-2">Login</Link></p>
        </form>
        </div>
        <div>
